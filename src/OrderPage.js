...
export default function OrderPage({ onClose, product, onPaymentSuccess }) {
  ...
  const prices = useMemo(() => {
    if (product?.title?.includes('Видео-приглашения')) {
      return {
        noAnim: {
          'unnamed': { title: 'Неименное приглашение', price: 2000, term: '1 день' },
          '25': { title: 'Именное приглашение (до 25 имен)', price: 3000, term: '2-5 дней' },
          '50': { title: 'Именное приглашение (до 50 имен)', price: 4000, term: '2-5 дней' },
          '100': { title: 'Именное приглашение (51-100 имен)', price: 5000, term: '2-5 дней' }
        },
        anim: {
          'unnamed': { title: 'Неименное приглашение с оживлением', price: 4000, term: '2-3 дня' },
          '25': { title: 'Именное приглашение (до 25 имен) с оживлением', price: 5000, term: '3-6 дней' },
          '50': { title: 'Именное приглашение (до 50 имен) с оживлением', price: 6000, term: '3-6 дней' },
          '100': { title: 'Именное приглашение (51-100 имен) с оживлением', price: 7000, term: '4-7 дней' }
        }
      };
    } else {
       ...
       return {
         noAnim: {
           '16': { title: '4 разворота (16 фото, 6:23 мин)', price: 8000, term: '3–4 дня' },
           '20': { title: '5 разворотов (20 фото, 8 мин)', price: 8500, term: '3–4 дня' },
           '24': { title: '6 разворотов (24 фото, 10 мин)', price: 9000, term: '4–5 дней' },
           '28': { title: '7 разворотов (28 фото, 12 мин)', price: 9500, term: '4–5 дней' }
         },
         anim: {
           '16': { title: '4 разворота (16 фото, 6:23 мин) с оживлением', price: 10000, term: '4–5 дней' },
           '20': { title: '5 разворотов (20 фото, 8 мин) с оживлением', price: 11000, term: '4–5 дней' },
           '24': { title: '6 разворотов (24 фото, 10 мин) с оживлением', price: 11500, term: '5–6 дней' },
           '28': { title: '7 разворотов (28 фото, 12 мин) с оживлением', price: 12000, term: '5–6 дней' }
         }
       };
    }
  }, [product]);
